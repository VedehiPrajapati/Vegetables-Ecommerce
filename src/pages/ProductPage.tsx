  ...
  const fetchProducts = async () => {
    try {
      ...
      const formatted: Product[] = (res.data?.data || []).map((p: any) => {
        ...
        const price = typeof p.offerPrice === "number" ? p.offerPrice : parseFloat(p.offerPrice) || 0;
        return {
          id: p._id,
          name: p.name || "No Name",
          slug: p.slug || "",
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="md:hidden bg-white border-b sticky top-0 z-30">
        <div className="flex items-center px-4 py-2 gap-2">
          ...
          <button 
            ...
            className="flex items-center gap-1 bg-gray-100 px-3 py-1.5 rounded-full text-xs font-medium text-gray-700 border"
          >
                ...
                return (
                  <button
                    ...
                    className={`whitespace-nowrap px-3 py-1.5 rounded-full text-xs border ${
                      active ? "bg-green-500 text-white border-green-500" : "bg-gray-100 text-gray-700"
                    }`}
                  >
                    {cat.name}
                  </button>
      ...
      <div className="flex relative">
        ...
        <div
          className={`
            fixed md:static inset-y-0 left-0 z-50 bg-white border-r
            w-72 max-w-[80vw] h-full
        ...
        >
          ...
          <div className="p-4 space-y-6 overflow-y-auto h-[calc(100%-60px)] md:h-auto md:max-h-[85vh]">
            {/* Categories */}
            <div>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  placeholder="Min"
                  className="w-full border rounded px-3 py-2 text-sm focus:ring-1 focus:ring-green-500 outline-none"
                />
                <input
                  type="number"
                  value={priceMax}
            ...
            <button 
              onClick={() => setShowSidebar(false)}
              className="md:hidden w-full bg-green-500 text-white py-3 rounded-lg font-semibold mt-4 shadow-lg"
            >
